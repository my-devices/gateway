...
#line 8 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
...
#line 5 "/ws/my-devices.net/gateway/html/header.inc"
	...
	responseStream << "\t\t  <h1>";
#line 13 "/ws/my-devices.net/gateway/html/header.inc"
	responseStream << ( U::htmlize(pageTemplate["title"]) );
	responseStream << "</h1>\n";
	responseStream << "        </div>\n";
	responseStream << "      </div>\n";
	...
	responseStream << "\n";
#line 36 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
 if (!pageController.message().empty()) { 	responseStream << "\n";
	responseStream << "  <div class=\"error\">\n";
	responseStream << "    ";
#line 38 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	responseStream << ( U::htmlize(pageController.message()) );
	responseStream << "\n";
	responseStream << "  </div>\n";
#line 40 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
 } 	responseStream << "\n";
...
#line 55 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	responseStream << ( pageController.deviceManager()->config()->getString("webtunnel.reflectorURI", "") );
	responseStream << "\">\n";
	responseStream << "            ";
#line 56 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	...
	responseStream << "        <td>\n";
	responseStream << "          ";
#line 63 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	...
	responseStream << "    <tbody>\n";
	responseStream << "      ";
#line 84 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"

      bool even = false;
      	responseStream << "\n";
	responseStream << "      ";
#line 87 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
 for (std::vector<std::string>::const_iterator it = pageController.devices().begin(); it != pageController.devices().end(); ++it) { 	responseStream << "\n";
	responseStream << "        ";
#line 88 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
...
#line 91 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
...
#line 93 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	...
	responseStream << "\">\n";
	responseStream << "              ";
#line 94 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	...
	responseStream << "          <td>\n";
	responseStream << "            ";
#line 98 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	responseStream << ( U::htmlize(pDeviceConfig->getString("webtunnel.deviceId", "")) );
	responseStream << "\n";
	responseStream << "          </td>\n";
	responseStream << "          <td>\n";
	responseStream << "            ";
#line 101 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	responseStream << ( U::htmlize(pDeviceConfig->getString("webtunnel.host", "")) );
	responseStream << "\n";
	responseStream << "          </td>\n";
	responseStream << "          <td>\n";
	responseStream << "            ";
#line 104 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
...
#line 107 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
...
#line 107 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	...
	responseStream << "        </tr>\n";
	responseStream << "        ";
#line 115 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
...
#line 118 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	...
	responseStream << "\n";
	responseStream << "      <tr class=\"";
#line 119 "/ws/my-devices.net/gateway/src/IndexPage.cpsp"
	responseStream << ( even ? "even" : "odd" );
	responseStream << "\">\n";
	...
	responseStream << "          ";
#line 6 "/ws/my-devices.net/gateway/html/footer.inc"
	responseStream << ( pageTemplate["softwareVersion"] );
	responseStream << " | &copy; 2015-2017 by <a href=\"https://www.appinf.com\">Applied Informatics</a>.\n";
	responseStream << "        </div>\n";
	responseStream << "      </div>\n";
	responseStream << "    </footer>\n";
	responseStream << "  </body>\n";
